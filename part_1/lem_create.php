...
$query="SELECT username FROM local_employee WHERE username='$s_unm'";
$result=$conn->query($query);
if ($result->num_rows > 0) {
	echo "Username already exists!";
}
else {
$sql = "INSERT INTO local_employee (username,password,όνομα,επίθετο, local_store) VALUES ('$s_unm','$s_pwd','$s_fname','$s_lname','$s_loc')";
